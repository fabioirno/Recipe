...
public class RecipesManager extends GeneratedRecipesManager
{
	...
	private static final Logger LOG = LoggerFactory.getLogger(RecipesManager.class);
	...
	public void init()
	{
		LOG.debug("init() of RecipesManager called, current tenant: {}", getTenant().getTenantID());
	}
