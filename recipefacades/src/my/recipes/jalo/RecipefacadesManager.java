...
/**
 * This is the extension manager of the Recipefacades extension.
 */
public class RecipefacadesManager extends GeneratedRecipefacadesManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(RecipefacadesManager.class);
	 ...
	 */
	public static RecipefacadesManager getInstance()
	{
		return (RecipefacadesManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(RecipefacadesConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public RecipefacadesManager() // NOPMD 
	{
		LOG.debug("constructor of RecipefacadesManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of RecipefacadesManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of RecipefacadesManager called, current tenant: {}", getTenant().getTenantID());
	}
