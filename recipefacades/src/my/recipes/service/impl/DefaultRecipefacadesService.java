...
public class DefaultRecipefacadesService implements RecipefacadesService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultRecipefacadesService.class);
	...
	{
		return DefaultRecipefacadesService.class.getResourceAsStream("/recipefacades/sap-hybris-platform.png");
	}
