 ...
 */
package my.recipes.v1.controller;
...
import my.recipes.constants.YcommercewebservicesConstants;
import my.recipes.formatters.WsDateFormatter;
import my.recipes.product.data.ProductDataList;
import my.recipes.product.data.SuggestionDataList;
import my.recipes.queues.data.ProductExpressUpdateElementData;
import my.recipes.queues.data.ProductExpressUpdateElementDataList;
import my.recipes.queues.impl.ProductExpressUpdateQueue;
import my.recipes.stock.CommerceStockFacade;
import my.recipes.util.ws.SearchQueryCodec;
import my.recipes.validator.PointOfServiceValidator;
...
public class ProductsController extends BaseController
{
	 ...
	 * {@link my.recipes.populator.HttpRequestReviewDataPopulator} to populate review data
