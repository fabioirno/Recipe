...
import my.recipes.populator.HttpRequestAddressDataPopulator;
import my.recipes.populator.HttpRequestCustomerDataPopulator;
import my.recipes.populator.HttpRequestPaymentInfoPopulator;
import my.recipes.populator.options.PaymentInfoOption;
import my.recipes.user.data.AddressDataList;
import my.recipes.user.data.LoginChangeResponse;
import my.recipes.user.data.PasswordRestoreResponse;
import my.recipes.validation.data.AddressValidationData;
