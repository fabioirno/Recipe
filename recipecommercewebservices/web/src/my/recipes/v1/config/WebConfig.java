 ...
 */
package my.recipes.v1.config;


import de.hybris.platform.servicelayer.config.ConfigurationService;
import my.recipes.request.mapping.handler.CommerceHandlerMapping;
...
{
	private static final String PASSWORD_AUTHORIZATION_SCOPE = "recipecommercewebservices.oauth2.password.scope";
	private static final String CLIENT_CREDENTIAL_AUTHORIZATION_SCOPE = "recipecommercewebservices.oauth2.clientCredentials.scope";
	private static final String AUTHORIZATION_URL = "recipecommercewebservices.oauth2.tokenUrl";

	private static final String DESC = "recipecommercewebservices.v1.description";
	private static final String TITLE = "recipecommercewebservices.v1.title";
	private static final String VERSION = "recipecommercewebservices.v1.version";
