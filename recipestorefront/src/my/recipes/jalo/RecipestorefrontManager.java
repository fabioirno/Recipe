...
/**
 * This is the extension manager of the Recipestorefront extension.
 */
public class RecipestorefrontManager extends GeneratedRecipestorefrontManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(RecipestorefrontManager.class);
	...
	{
		return (RecipestorefrontManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(RecipestorefrontConstants.EXTENSIONNAME);
	}
	...
	public void init()
	{
		LOG.debug("init() of RecipestorefrontManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of RecipestorefrontManager called, current tenant: {}", getTenant().getTenantID());
	}
