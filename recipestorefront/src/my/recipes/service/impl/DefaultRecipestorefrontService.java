...
public class DefaultRecipestorefrontService implements RecipestorefrontService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultRecipestorefrontService.class);
	...
	{
		return DefaultRecipestorefrontService.class.getResourceAsStream("/recipestorefront/sap-hybris-platform.png");
	}
