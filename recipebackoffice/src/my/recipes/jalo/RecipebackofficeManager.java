...
import my.recipes.constants.RecipebackofficeConstants;
 ...
 */
public class RecipebackofficeManager extends GeneratedRecipebackofficeManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(RecipebackofficeManager.class.getName());
	 ...
	 */
	public static RecipebackofficeManager getInstance()
	{
		return (RecipebackofficeManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(RecipebackofficeConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public RecipebackofficeManager() // NOPMD
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of RecipebackofficeManager called.");
		}
	}
